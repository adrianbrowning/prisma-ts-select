...
describe("PostgreSQL datetime dialect fns", () => {
  ...
  describe("year(col) override", () => {
    ...
    it("type: number", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ y: number; }>>>);
    });
  ...
  describe("month(col) override", () => {
    ...
    it("type: number", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ m: number; }>>>);
    });
  ...
  describe("day(col) override", () => {
    ...
    it("type: number", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ d: number; }>>>);
    });
  ...
  describe("hour(col) override", () => {
    ...
    it("type: number", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ h: number; }>>>);
    });
  ...
  describe("extract(field, col)", () => {
    ...
    it("type: number", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ dow: number; }>>>);
    });
  });
  ...
  describe("dateTrunc(unit, col)", () => {
    ...
    it("type: Date", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ trunc: Date; }>>>);
    });
  });
