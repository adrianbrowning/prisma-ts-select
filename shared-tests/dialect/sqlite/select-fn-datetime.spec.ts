...
describe("SQLite datetime dialect fns", () => {
  ...
  describe("now() override", () => {
    ...
    it("type: Date", async () => {
      ...
      typeCheck({} as Expect<Equal<typeof _result, Array<{ ts: Date; }>>>);
    });

    it("should return non-null _result", async () => {
      const _result = await createQuery().run();
      assert.ok(_result.length > 0);
      // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition, sonarjs/different-types-comparison
      assert.ok(_result[0]!.ts !== null && _result[0]!.ts !== undefined);
    });
  });
  ...
  describe("curDate() override", () => {
    ...
    it("type: Date", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ d: Date; }>>>);
    });
    ...
    it("should return non-null _result", async () => {
      ...
      assert.ok(_result.length > 0);
      // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition, sonarjs/different-types-comparison
      assert.ok(_result[0]!.d !== null && _result[0]!.d !== undefined);
    });
  });
  ...
  describe("year(col) override", () => {
    ...
    it("type: string", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ y: string; }>>>);
    });

    it("should return correct years", async () => {
      const _result = await createQuery().run();
      const years = _result.map(r => r.y).sort((a, b) => a.localeCompare(b));
  ...
  describe("month(col) override", () => {
    ...
    it("type: string", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ m: string; }>>>);
    });

    it("should return correct months", async () => {
      const _result = await createQuery().run();
      const months = _result.map(r => r.m).sort((a, b) => a.localeCompare(b));
  ...
  describe("day(col) override", () => {
    ...
    it("type: string", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ d: string; }>>>);
    });

    it("should return correct days", async () => {
      const _result = await createQuery().run();
      const days = _result.map(r => (r.d)).sort((a, b) => a.localeCompare(b));
  ...
  describe("hour(col) override", () => {
    ...
    it("type: string", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ h: string; }>>>);
    });

    it("should return correct hours", async () => {
      const _result = await createQuery().run();
      const hours = _result.map(r => r.h).sort((a, b) => a.localeCompare(b));
  ...
  describe("minute(col) override", () => {
    ...
    it("type: string", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ min: string; }>>>);
    });
  });
  ...
  describe("second(col) override", () => {
    ...
    it("type: string", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ sec: string; }>>>);
    });
  });
  ...
  describe("strftime(fmt, col)", () => {
    ...
    it("type: string", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ ym: string; }>>>);
    });

    it("should return year-month strings", async () => {
      const _result = await createQuery().run();
      const ym = _result.map(r => r.ym).sort((a, b) => String(a).localeCompare(String(b)));
  ...
  describe("julianday(col)", () => {
    ...
    it("type: number", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ jd: number; }>>>);
    });

    it("should return positive julian day numbers", async () => {
      const _result = await createQuery().run();
      assert.ok(_result.every(r => typeof r.jd === "number" && r.jd > 0));
    });
  });
  ...
  describe("date(col)", () => {
    ...
    it("should return date strings", async () => {
      const _result = await createQuery().run();
      const dates = _result.map(r => r.d).sort((a, b) => String(a).localeCompare(String(b)));
  ...
  describe("datetime(col)", () => {
    ...
    it("type: string", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ dt: string; }>>>);
    });

    it("should return datetime strings", async () => {
      const _result = await createQuery().run();
      const dts = _result.map(r => r.dt).sort((a, b) => String(a).localeCompare(String(b)));
