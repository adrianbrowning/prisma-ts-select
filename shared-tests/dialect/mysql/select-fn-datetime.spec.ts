...
describe("MySQL datetime dialect fns", () => {
  ...
  describe("year(col)", () => {
    ...
    it("type: bigint", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ y: bigint; }>>>);
    });
  ...
  describe("month(col)", () => {
    ...
    it("type: bigint", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ m: bigint; }>>>);
    });
  ...
  describe("day(col)", () => {
    ...
    it("type: bigint", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ d: bigint; }>>>);
    });
  ...
  describe("hour(col)", () => {
    ...
    it("type: bigint", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ h: bigint; }>>>);
    });
  ...
  describe("minute(col)", () => {
    ...
    it("type: number", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ min: number; }>>>);
    });
  });
  ...
  describe("second(col)", () => {
    ...
    it("type: number", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ sec: number; }>>>);
    });
  });
  ...
  describe("dateAdd(col, n, unit)", () => {
    ...
    it("type: Date", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ added: Date; }>>>);
    });
  });
  ...
  describe("dateFormat(col, fmt)", () => {
    ...
    it("type: string", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ fmt: string; }>>>);
    });

    it("should format dates", async () => {
      const result = await createQuery().run();
      const fmts = result.map(r => r.fmt).sort((a, b) => String(a).localeCompare(String(b)));
  ...
  describe("quarter(col)", () => {
    ...
    it("type: bigint", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ q: bigint; }>>>);
    });
  ...
  describe("dayName(col)", () => {
    ...
    it("type: string", async () => {
      const _result = await createQuery().run();
      typeCheck({} as Expect<Equal<typeof _result, Array<{ dn: string; }>>>);
    });

    it("should return day names", async () => {
      const result = await createQuery().run();
      const names = result.map(r => r.dn).sort((a, b) => String(a).localeCompare(String(b)));
