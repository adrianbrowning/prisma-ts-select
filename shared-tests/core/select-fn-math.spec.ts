...
describe("select() math fn context", () => {
  ...
  describe("abs(lit(-5))", () => {
    it("should match SQL", () => {
      expectSQL(prisma.$from("User").select(({ abs, lit }) => abs(lit(-5)), "v")
        .getSQL(),
  ...
  describe("abs(col) — nullable column", () => {
    it("should match SQL", () => {
      const sql = prisma.$from("User").select(({ abs }) => abs("User.age"), "v")
        .getSQL();
      expectSQL(sql,
  ...
  describe("ceil(lit(4.2))", () => {
    it("should match SQL", () => {
      expectSQL(prisma.$from("User").select(({ ceil, lit }) => ceil(lit(4.2)), "v")
        .getSQL(),
  ...
  describe("floor(lit(4.8))", () => {
    it("should match SQL", () => {
      expectSQL(prisma.$from("User").select(({ floor, lit }) => floor(lit(4.8)), "v")
        .getSQL(),
  ...
  describe("round(lit(4.567), 2)", () => {
    it("should match SQL", () => {
      expectSQL(prisma.$from("User").select(({ round, lit }) => round(lit(4.567), 2), "v")
        .getSQL(),
  ...
  describe("round(lit(4.5)) — no decimals", () => {
    it("should match SQL", () => {
      expectSQL(prisma.$from("User").select(({ round, lit }) => round(lit(4.5)), "v")
        .getSQL(),
  ...
  describe("power(lit(2), 3)", () => {
    it("should match SQL", () => {
      expectSQL(prisma.$from("User").select(({ power, lit }) => power(lit(2), 3), "v")
        .getSQL(),
  ...
  describe("sqrt(lit(16))", () => {
    it("should match SQL", () => {
      expectSQL(prisma.$from("User").select(({ sqrt, lit }) => sqrt(lit(16)), "v")
        .getSQL(),
  ...
  describe("mod(lit(10), 3)", () => {
    it("should match SQL", () => {
      expectSQL(prisma.$from("User").select(({ mod, lit }) => mod(lit(10), 3), "v")
        .getSQL(),
  ...
  describe("sign(lit(-7))", () => {
    it("should match SQL", () => {
      expectSQL(prisma.$from("User").select(({ sign, lit }) => sign(lit(-7)), "v")
        .getSQL(),
  ...
  describe("exp(lit(0))", () => {
    it("should match SQL", () => {
      expectSQL(prisma.$from("User").select(({ exp, lit }) => exp(lit(0)), "v")
        .getSQL(),
