...
export const sqliteContextFns = <TColEntries extends [string, unknown] = [string, unknown]>(quoteFn: (ref: string) => string) => ({
...
export type DialectFns<TColEntries extends [string, unknown] = [string, unknown]> = ReturnType<typeof sqliteContextFns<TColEntries>>;
